...
;              
CREATE USER IF NOT EXISTS "SA" SALT 'c92de65966b7d69d' HASH '37767d2c256d806b37ed445bddeb59c1a1fbc9bd31900b8826e125ae517d7c1a' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TIMESTAMP '2025-12-01 17:17:31.20798', TRUE, FALSE, TRUE, FALSE, '$2a$10$BqERXdujAEFkkdldI3cZi./e..Kig2QNa.djvH9tAxLxPJ34igRk2', NULL, NULL, NULL, TIMESTAMP '2025-12-01 17:17:31.208133', 'admin', 1);      
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "CREATED_AT", "ENABLED", "HAS_COMPLETED_INITIAL_SETUP", "IS_FIRST_LOGIN", "OAUTH_GRANDFATHERED", "PASSWORD", "ROLE_NAME", "SSO_PROVIDER", "SSO_PROVIDER_ID", "UPDATED_AT", "USERNAME", "TEAM_ID") VALUES(2, '88a6ee91-c4b2-4b6c-8895-67d63d6eee07', 'web', TIMESTAMP '2025-12-01 17:17:31.351335', TRUE, FALSE, FALSE, FALSE, '$2a$10$4tAH/8AnF3KWBn01bm63j.JSbJYlDO5P5dLnITBlohANoW1QNy0xi', NULL, NULL, NULL, TIMESTAMP '2025-12-01 17:17:31.398615', 'STIRLING-PDF-BACKEND-API-USER', 2);          
